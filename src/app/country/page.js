        ...
        <a href="#"
          ...
          <div className="flex-1">
            ...
            <span className="flex items-baseline text-lg font-bold text-indigo-600">
              ...
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" stroke-linejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </span>
          </div>
        </a>
        <a href="#"
